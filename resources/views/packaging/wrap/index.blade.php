                        ...
                        <div class="col-12 ">
                            ...
                            <div class="row ">
                                ...
                                <a href="{{route('supporter.orders.index',['state'=>'today','from'=>'1','to'=>'1'])}}"
                                   class="col-sm-3 mr-1 btn btn-outline-dark" style="margin-right: 10px"> Today
                                    Orders</a>
                                <a href="{{route('supporter.orders.index',['state'=>'7days','from'=>'1','to'=>'1'])}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <a class="btn btn-primary" href="{{route('custom_orders_export')}}">Export To
                                        Excel</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('supporter.orders.postDate')}}" method="post">
                        @csrf
