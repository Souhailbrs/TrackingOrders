                                    ...
                                    <table id="datatable"
                                        ...
                                        @foreach($records as $record)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-dark col-sm-12 d-block" data-toggle="modal" data-target="#exampleModalCenterBox{{$record->id}}">
                                                        Add To Box
                                                    </a>
                                                </td>
...
@foreach($records as $record)
    ...
    <div class="modal fade" id="exampleModalCenterBox{{$record['id']}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle"> Add To Box</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" style="height:200px">
                    <table class="table col-sm-12 table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <form action="{{route('packaging.change.order_state.tobox')}}" method="post">
                                <tr>
                                @csrf
                            <td colspan="2">
                                Avilable boxes
                            ...
                            <td colspan="3">
                                <?php
                                $aviable_boxes = \App\Models\Box::where('zone_id',$record['zone_id'])->get();
                                ?>
                                    <input type="hidden" name="order" value="{{$record->id}}">
                                    <input type="hidden" name="old" value="{{$record->status}}">
                                    <input type="hidden" name="new" value="{{8}}">

                                    <select name="box_id" class="col-sm-12">
                                            @foreach($aviable_boxes as $av)
                                                <option value="{{$av->id}}">
                                                    {{'Box # ' . $av->id }}
                                                </option>
                                            @endforeach
                                ...
                                <tr>
                                    <td colspan="5">
                                        <button type="submit" class="btn btn-dark">Add To Box</button>
