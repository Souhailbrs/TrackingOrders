                                                ...
                                                <thead>
                                                    <tr>
                                                        <td colspan="6">
                                                            ...
                                                            <input type="button" class="btn btn-outline-primary col-sm-6"
                                                                value="Print All" onclick="printAll('allInvoices');">
                                                            <div class="btn dropdown col-sm-6">
                                                                <button class=" btn btn-outline-primary col-sm-12"
                                                                ...
                                                                <div class="dropdown-menu"
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('packaging.wrapping.sentOrders', ['day' => $day, 'filter' => 'all']) }}">{{ __('orders.all_orders') }}</a>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('packaging.wrapping.sentOrders', ['day' => $day, 'filter' => 2]) }}">{{ __('orders.no_answer_call_center') }}</a>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('packaging.wrapping.sentOrders', ['day' => $day, 'filter' => 6]) }}">{{ __('orders.canceled_order') }}</a>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('packaging.wrapping.sentOrders', ['day' => $day, 'filter' => 10]) }}">{{ __('orders.customer_received') }}</a>
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <th>{{ __('main.confirmed_supporter') }}</th>
                                                        <th>{{ __('main.confirmed_delivery') }}</th>
                                                        <th>{{ __('main.zone_delivery') }}</th>
                                                ...
                                                <tbody style="width:auto">
                                                    @foreach ($records as $record)
                                                        <tr
                                                            ...
                                                            <td class="text-center">
                                                                @if (HelperController::getSupporterConfimred($record->id) != null)
                                                                    {{ HelperController::getSupporterConfimred($record->id) }}
                                                                @else
                                                                    {{ 'Unknown' }}
                                                                @endif
                                                            </td>
                                                            <td class="text-center">
                                                                @if (HelperController::getDelivery($record->id) != null)
                                                                    {{ HelperController::getDelivery($record->id) }}
                                                                @else
                                                                    {{ 'Unknown' }}
                                                                @endif
                                                            </td>
                                                            <td class="text-center">
                                                                @if (HelperController::getZoneDelivery($record->id) != null)
                                                                    {{ HelperController::getZoneDelivery($record->id) }}
                                                                @else
                                                                    {{ 'Unknown' }}
                                                                @endif
                                                            </td>
                                                                ...
                                                                <center>
                                                                    ...
                                                                    <div class="btn-group" role="group">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            <a class="dropdown-item col-sm-12 d-block"
                                                                                href="{{ route('packaging.trackOrder', ['id' => $record->id]) }}">View</a>
                                                                            <a class="dropdown-item  col-sm-12 d-block"
                    ...
                    <div class="modal-footer">
                        <center>
                            <button type="button" class="btn btn-primary"
                                onclick="printContent('printLabel{{ $record->id }}');">Print</button>
                        </center>
                    </div>
                </div>
            </div>
