        ...
        <header class="top-header">
            <nav class="navbar navbar-expand gap-3">
                ...
                {{-- <div class="dropdown d-inline-block mr-3 h6" style="cursor:pointer;font-size: 20px">
                    <form action="{{ route('delivery.workState.sad') }}" method="post" style="font-weight: bolder">
                        @csrf
                                        ...
                                        <div class="d-flex flex-row align-items-center gap-2">
                                            ...
                                            <div class="">
                                                <h6 class="mb-0 dropdown-user-name">
                                                    {{ Auth::guard('delivery')->user()->name }}</h6>
                                                <small
                                                    class="mb-0 dropdown-user-designation text-secondary">{{ Auth::guard('delivery')->user()->email }}</small>
                                            </div>
                                        </div>
                                    </a>
                                </li>
