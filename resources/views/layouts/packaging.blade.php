                ...
                {{-- <div class="dropdown d-inline-block mr-3 h6" style="cursor:pointer;font-size: 20px">
                    <form action="{{route('packaging.workState.sad')}}" method="post" style="font-weight: bolder">
                        ...
                        <div class=" form-check form-switch pt-4 waves-effect" >
                            ...
                            @if($today_work == 1)
                                <input class="  form-check-input" type="checkbox" id="flexSwitchCheckDefault" checked switch="dark"  onchange="submit()"  name="state"/>
                            @else
                                <input class="  form-check-input" type="checkbox" id="flexSwitchCheckDefault" switch="dark"  onchange="submit()"  name="state"/>
                            @endif
                ...
                <ul class="navbar-nav align-items-center">
                    <li class="d-flex dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" rel="alternate" hreflang="{{ 'ar' }}" href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}">العربية</a></li>
                            <li><a class="dropdown-item" rel="alternate" hreflang="{{ 'en' }}" href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}">English</a></li>
                        </ul>
                    </li>
