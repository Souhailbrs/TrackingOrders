                            ...
                            @else
                                <form method="post"
                                   ...
                                   <div class="form-control text-center" style="border: 0 solid black">
                                        ...
                                        ?>
                                        <a style="display:inline-block;margin-right: 30px" href="https://api.whatsapp.com/send?phone={{ $data->customer_phone1 }}&text={{$whats}}" data-action="share/whatsapp/share" target="_blank" class=" ">
                                                            ...
                                                            <select class="form-control products_id product_id_view"
                                                                ...
                                                                @foreach($data->shop->products as $proo)
                                                                    @if($proo->product->id != $pro->one_product->id)
                                                                        <option
                                                                            value="{{$proo->product->id}}">{{$proo->product->name}}</option>
                                                                    @endif
                                                                @endforeach
                                                            </select>
                                                        </div>
