                    ...
                    <div class="row">
                        <div class="col-12 ">
                            ...
                            <div class="row ">
                                ...
                                <a href="{{route('supporter.orders.index',['state'=>'today','from'=>'1','to'=>'1'])}}" class="col-sm-3 mr-1 btn btn-dark"> Today Orders</a>
                                <a href="{{route('supporter.orders.index',['state'=>'7days','from'=>'1','to'=>'1'])}}" class="col-sm-3 mr-1 btn btn-dark">Last 7 Days</a>
                                    ...
                                    <table id="datatable"
                                        ...
                                        @foreach($records as $record)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-dark col-sm-12 d-block"  target="_blank" href="{{route('supporter.site.trackOrder',['id'=>$record->id])}}">
                                                        View
                                                    </a>
                                                </td>
