                        ...
                        <div class="row">
                            <div class="col-12 ">
                                ...
                                <div class="text-center row">
                                    ...
                                    <a href="{{route('supporter.orders.index',['state'=>'today','from'=>'1','to'=>'1'])}}" class="col-sm-3  btn btn-primary"> Today Orders</a>
                                    <div class="col-sm-1 text-center "></div>
                                    <a href="{{route('supporter.orders.index',['state'=>'7days','from'=>'1','to'=>'1'])}}" class="col-sm-3  btn btn-primary">Last 7 Days</a>
                                    <div class="col-sm-1 text-center "></div>
                                    <a  data-bs-toggle="modal" data-bs-target="#exampleModalCenterCustom"  class="col-sm-3 btn btn-primary">Custom Date</a>
