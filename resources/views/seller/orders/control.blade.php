...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="row text-center" action="{{ route('seller.import.orders') }}" method="post"
                        ...
                        <div class="col-sm-6">
                            ...
                            <select class="btn btn-dark col-sm-4" name="sales_channel_id" required
                        ...
                        <div class="col-sm-3">
                            ...
                            <a type="submit" download href="{{ asset('assets/admin/old/orders/temp.xlsx') }}">Download
                                Template</a>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-sm-12 ">
                            ...
                            <input class="form-control btn-dark text-center" type="button" id="example-text-input-mokaaa"
                    ...
                    <div id="product_id" style="display:none;">
                        <div class="row mt-2">
                            ...
                            <div id="i" type="button" class="col-sm-3 btn btn-danger" onclick="removeClone(this)">
                                remove
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="example-text-input" required name="customer_name"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" type="text" id="example-text-input" name="customer_notes">
@if ($action == 'update')
{{ $data->customer_notes }}
@endif
</textarea>
                    ...
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">{{ __('Product Url') }}</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="example-text-input" required name="url">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" type="text" id="example-text-input" name="customer_address">
@if ($action == 'update')
{{ $data->customer_notes }}
@endif
</textarea>
            ...
            $('#zone_id').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        data.forEach(district => districts.innerHTML += "<option value=" +
                            district.id + ">" + district['title_en'] + "</option>");
                        //console.log(typeof data);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < shops.length; i++) {
                            shops[i].innerHTML = "";
                            data.forEach(shop => shops[i].innerHTML += "<option value=" + shop[
                                    'product_id'] + ">" + shop['product_name'] +
                                "</option>");
                        }
