                    ...
                    <div class="row">
                        <div class="col-12 ">
                            ...
                            <div class="row ">
                                ...
                                <a href="{{route('seller.orders.index',['state'=>'today','from'=>'1','to'=>'1'])}}"
                                   class="col-sm-3 mr-1 btn btn-outline-dark" style="margin-right: 10px"> Today
                                    Orders</a>
                                <a href="{{route('seller.orders.index',['state'=>'7days','from'=>'1','to'=>'1'])}}"
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <form
                                        action="{{route('seller.orders.index',['state'=>$state,'from'=>$from,'to'=>$to])}}"
                                        method="get">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <a class="btn btn-primary" href="{{route('custom_orders_export',$pagination)}}">Export To
                                        Excel</a>
                                                ...
                                                <!--                                                <td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <div class="col- m-1 p-1 pr-2 pl-2 btn btn-success "
                                                            ...
                                                            <a href="tel:+ {{$record->customer_phone1}}" target="_blank"
                                                               height="40" width="40"
                                                    ...
                                                    <td class="text-center">
                                                        <a
                                                            ...
                                                            @elseif( $record->status == 1)
                                                                <span class="btn btn-light"
                                                                      style="width: 200px;"> {{__('orders.call_center_received')}}</span>
                                                            @elseif( $record->status == 2 )
                                                                <span class=" btn btn-warning"
                                                                      style="width: 200px;">  {{__('orders.no_answer_call_center')}}</span>
                                                            @elseif ($record->status == 3)
                                                                <span class="btn btn-dark"
                                                                      style="width: 200px;">  {{__('orders.wrong_answer')}}</span>
                                                            @elseif($record->status == 4)
                                                                <span class="btn btn-blue"
                                                                      style="width: 200px;">  {{__('orders.confirm_order')}}</span>
                                                            @elseif( $record->status == 5)
                                                                <span class="btn btn-secondary"
                                                                      style="width: 200px;"> {{__('orders.not_confirm_order')}}</span>
                                                            @elseif($record->status == 6)
                                                                <span class="btn btn-danger"
                                                                      style="width: 200px;">  {{__('orders.canceled_order')}}</span>
                                                            @elseif($record->status == 7)
                                                                <span class="btn btn-info"
                                                                      style="width: 200px;">  {{__('orders.ready_to_be_delivered')}}</span>
                                                            @elseif($record->status == 8)
                                                                <span class="btn btn-info"
                                                                      style="width: 200px;">{{__('orders.received_by_delivery')}}</span>
                                                            @elseif($record->status == 9)
                                                                <span class="btn btn-danger"
                                                                      style="width: 200px;"> {{__('orders.delivery_refused_order')}}</span>
                                                            @elseif($record->status == 10)
                                                                <span class="btn btn-success"
                                                                      style="width: 200px;"> {{__('orders.customer_received')}}</span>
                                                            @elseif($record->status == 11)
                                                                <span class="btn btn-danger"
                                                                      style="width: 200px;">{{__('orders.canceled_order')}}</span>
                                                            @elseif($record->status == 12)
                                                                <span class="btn btn-warning"
                                                                      style="width: 200px;"> {{__('orders.no_answer_delivery_boy')}}</span>
                                                            @elseif($record->status == 13)
                                                                <span class="btn btn-danger"
                                                                      style="width: 200px;">  {{__('orders.customer_didnot_deliver')}}</span>
                                                            @endif
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('seller.orders.postDate')}}" method="post">
                        @csrf
