                                                    ...
                                                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                                <a class="btn btn-dark col-sm-12"  href="{{route('showRequests.change',['state'=>1,'id'=>$record->id])}}">Accept</a>
                                                                <br>
                                                                <a class="btn btn-dark col-sm-12"  href="{{route('showRequests.change',['state'=>2,'id'=>$record->id])}}">Refuse</a>
                                                                <br>
                                                                <a class="btn btn-dark col-sm-12"  href="{{route('inventories.edit',['inventory'=>$record->id])}}">Modify</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
