                        ...
                        <h6>
                            ...
                            <div class="container">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        @foreach($values as $val)
                                            @if($val->field == 'feature_title_ar_'.$i)
                                        <input class="form-control" type="text" id="example-text-input" name="feature_title_ar_{{$i}}"
                                               required value="{{$val->value}}">
                                                @endif
                                        @endforeach
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        @foreach($values as $val)
                                        @if($val->field == 'feature_title_en_'.$i)
                                        <input class="form-control" type="text" id="example-text-input" name="feature_title_en_{{$i}}"
                                               required value="{{$val->value}}">
                                        @endif
                                        @endforeach
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        @foreach($values as $val)
                                            @if($val->field == 'feature_description_ar_'.$i)
                                        <textarea class="form-control" type="text" id="example-text-input"
                                                  name="feature_description_ar_{{$i}}" required>{{$val->value}}</textarea>
                                            @endif
                                        @endforeach
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        @foreach($values as $val)
                                            @if($val->field == 'feature_description_en_'.$i)
                                                <textarea class="form-control" type="text" id="example-text-input"
                                                          name="feature_description_en_{{$i}}" required>{{$val->value}}</textarea>
                                            @endif
                                        @endforeach
                                    </div>
                                </div>
