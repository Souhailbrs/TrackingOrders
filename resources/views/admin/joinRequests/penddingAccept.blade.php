                                                        ...
                                                        <center>
                                                            ...
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                                    ...
                                                                    <a class="btn btn-dark col-sm-12 d-block"  data-toggle="modal" data-target="#exampleModalCentercreate{{$record->id}}">Create Account</a>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group row">
                                    <a class="btn btn-dark col-sm-12 d-block"  href="{{route('change.requests.accept',['requestId'=>$record->id])}}">Accept Request</a>
                                    <hr>
                                    ...
                                    <iframe src="{{asset('assets/admin/joinRequests/'.$record->file)}}" width="100%" height="500px">
                                    </iframe>
                                </div>
