                                        ...
                                        <div class="table-responsive">
                                            ...
                                            @foreach ($records as $record)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('districts.edit',['district'=>$record->id])}}" class="mr-3 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="mdi mdi-pencil font-size-18"></i></a>

                                                        <form action="{{route('districts.destroy',['district'=>$record->id])}}" method="post" style="display:inline-block">
                                                            @method('DELETE')
                                                            @csrf
