...
Route::group(
    ...
    Route::get('/home/{type_users}', 'SupporterStatisticsController@index')->name('home');
    Route::post('filter/statistics/{type_users}', 'SupporterStatisticsController@index')->name('filter.statistics');
