...
Route::group(
    ...
    function () { //...
        ...
        Route::post('filter/statistics/{type_users}', 'StatisticsController@index')->name('admin.filter.statistics');
        ...
        Route::get('joinRequests/search/{type}', 'JoinRequests@searchRequests')->name('admin.search.requests');
        ...
        Route::get('ordersSettingsCountries', 'OrdersController@viewSettingsCountries')->name('admin.orders.settings.countries');
        Route::get('ordersSettings/{country}', 'OrdersController@viewSettings')->name('admin.orders.settings');
        Route::post('ordersSettings', 'OrdersController@UpdateSettings')->name('admin.orders.update.settings');
        ...
        Route::post('orders/clearHistory', 'OrdersController@deleteOders')->name('admin.orders.deleteOrders');
