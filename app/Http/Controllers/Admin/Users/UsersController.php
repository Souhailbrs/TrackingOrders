...
class UsersController extends Controller
{
    ...
    public function getStatistics(Request $request)
    {
        ...
        dd($statistics->indexFilter($request,'supporter'));
        ...
        $res = [
            ...
            'new_orders' => 1,
            'delivered_orders' => 1,
            'cancelled_orders_delivery' => 1,
            'cancelled_orders_call_center' => 1,
            'delivered_percentage' => 1,
            'confirmed_percentage' => 1,
            'cancelled_percentage' => 1
        ];
        return view('admin.users.statistics', compact('res'));
    }
